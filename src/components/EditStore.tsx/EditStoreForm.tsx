...
import AddressSearch from "../newStore/AddressSearch";
import axios from "axios";

const EditStoreForm = ({ data }: { data: StoreType }) => {
  ...
  const formSubmit = async (data) => {
    try {
      ...
      console.log(e);
      alert("데이터 수정중 문제가 생겼습니다. 다시 시도해주세요.");
    }
  };

  return (
    <form
      className="px-4 md:max-w-4xl mx-auto py-8 mt-14"
